...
class TextStyles {
  ...
  static final TextStyle f14w500Gray9 = GoogleFonts.inter(
    fontSize: 14,
    fontWeight: FontWeight.w500,
  ...
  static final TextStyle f10w500Gray5 = GoogleFonts.inter(
    fontSize: 10,
    fontWeight: FontWeight.w500,
  ...
  static final TextStyle f12w700pinkish =  GoogleFonts.interTight(
    fontSize: 12,
    fontWeight: FontWeight.w700,
    color: AppColors.pinkish,
  );
  static final TextStyle f12w600Gray5 =  GoogleFonts.interTight(
    fontSize: 12,
    fontWeight: FontWeight.w600,
    color: AppColors.mGray5,
  );
  ...
  static final TextStyle f12w600primary =  GoogleFonts.inter(
    fontSize: 12,
    fontWeight: FontWeight.w600,
    color: AppColors.primary,
    height: 1.0,
  );
  static final TextStyle f12w700primary =  GoogleFonts.inter(
    fontSize: 12,
    fontWeight: FontWeight.w700,
    color: AppColors.primary,
    height: 1.0,
  );
  static final TextStyle f12w700b =  GoogleFonts.inter(
    fontSize: 12,
    fontWeight: FontWeight.w700,
  ...
  static final TextStyle f11w400Gray5 =  GoogleFonts.inter(
    fontSize: 11,
    fontWeight: FontWeight.w400,
    color: AppColors.mGray5,
  );
  ...
  static final TextStyle f11w600Gray9 =  GoogleFonts.inter(
    fontSize: 11,
    fontWeight: FontWeight.w600,
    color: AppColors.mGray9,
    height: 0.2,
  );
  static final TextStyle f11w400Gray9 =  GoogleFonts.inter(
    fontSize: 11,
    fontWeight: FontWeight.w400,
    color: AppColors.mGray9,
  );
  ...
  static final TextStyle f9w700mGray9 = GoogleFonts.inter(
    fontSize: 9,
    fontWeight: FontWeight.w700,
    color: AppColors.mGray9,
    height: 1.0,
  );
  static final TextStyle f9w400mGray5 = GoogleFonts.inter(
    fontSize: 9,
    fontWeight: FontWeight.w400,
    color: AppColors.mGray5,
    height: 1.0,
  );
  static final TextStyle f9w500primary = GoogleFonts.inter(
    fontSize: 9,
    fontWeight: FontWeight.w500,
    color: AppColors.primary,
    height: 1.0,
  ...
  static final TextStyle f8w400mSecondary = GoogleFonts.inter(
    fontSize: 8,
    fontWeight: FontWeight.w400,
    color: AppColors.primarySecond,
    height: 1.0,
  );
  static final TextStyle f8w600mGray9 = GoogleFonts.inter(
    fontSize: 8,
    fontWeight: FontWeight.w600,
    color: AppColors.mGray9,
    height: 1.0,
  );
  static final TextStyle f7w400mGray6 = GoogleFonts.inter(
    fontSize: 7,
    fontWeight: FontWeight.w400,
    color: AppColors.mGray6,
    height: 1.0,
  ...
  static final TextStyle f10w600Primary = GoogleFonts.inter(
    fontSize: 10,
    fontWeight: FontWeight.w600,
    color: AppColors.primary,
  );
  static final TextStyle f10w500Gray6 = GoogleFonts.inter(
    fontSize: 10,
    fontWeight: FontWeight.w500,
    height: 0.4,
    color: AppColors.mGray6,
  );
  static final TextStyle f10w500Gray7 = GoogleFonts.inter(
    fontSize: 10,
    fontWeight: FontWeight.w500,
  //  height: 0.4,
    color: AppColors.mGray7,
  );
  static final TextStyle f10w500Gray9 = GoogleFonts.inter(
    fontSize: 10,
    fontWeight: FontWeight.w500,
    height: 0.4,
    color: AppColors.mGray9,
  ...
  static final TextStyle f11w500Gray7 = GoogleFonts.inter(
    fontSize: 11,
    fontWeight: FontWeight.w500,
    //  height: 0.4,
    color: AppColors.mGray7,
  ...
  static final TextStyle f12w600mBlack = GoogleFonts.inter(
    fontSize: 12,
    fontWeight: FontWeight.w600,
    color: AppColors.mBlack,
  );

  static final TextStyle f10w700mBlack = GoogleFonts.inter(
    fontSize: 10,
    fontWeight: FontWeight.w700,
    color: AppColors.mBlack,
  );
