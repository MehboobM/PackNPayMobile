...
class _LetterHeadPageState extends State<LetterHeadPage> {
  ...
  Widget build(BuildContext context) {
    final canAddLetter = PermissionHelper.canAdd(ModuleCode.letterHead);
    return Scaffold(
  ...
  Widget _buildLetterHeadTile(dynamic data)  {
    ...
    final canEditLetter = PermissionHelper.canEdit(ModuleCode.letterHead);
    final canDeleteLetter = PermissionHelper.canDelete(ModuleCode.letterHead);
